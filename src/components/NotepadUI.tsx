...
export default function NotepadUI() {
    return (
        <div className="w-full h-full flex flex-col bg-white shadow-md border-t-gray-700 border-l-gray-700 border-r-gray-700 rounded-md overflow-hidden">
            {/* Upper tab*/}
            ...
            <div className="flex flex-col h-full">
                <div className="flex gap-6 px-3 py-1 border-gray-100 text-sm text-gray-700 shrink-0">
                ...
                <div className="bg-gray-50 px-3 py-2 border-t border-gray-100 text-xs text-gray-600 flex justify-between shrink-0">
                    <div>Ln 1, Col 1</div>
